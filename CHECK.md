# To do list for Dhammacharts
  ...
  - [ ] ^ remove description for item pages
  - [ ] ^ check jekyll errors
  ...
  - [ ] page for normal content with image in content lightboxed
  - [ ] code pages
  - [ ] Dark mode
  ...
  - [ ] there is script and vendor in the assets, should be one only, no lib ?
  ...
  - [ ] remove unused lib like masonry
  - [ ] remove title name in data and make new logic
